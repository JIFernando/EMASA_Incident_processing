...
public class ListaDeBrigadas implements Serializable {
    ...
    public ListaDeBrigadas() {
        ...
        Operario o1 = new Operario (); o1.setId_empl(1); o1.setNombre("Roose"); o1.setApellido1("Bolton"); o1.setApellido2("");
        Operario o2 = new Operario (); o2.setId_empl(2); o2.setNombre("Ramsay"); o2.setApellido1("Bolton"); o2.setApellido2("");
        Operario o3 = new Operario (); o3.setId_empl(3); o3.setNombre("Jon"); o3.setApellido1("Nieve"); o3.setApellido2("");
        Operario o4 = new Operario (); o4.setId_empl(4); o4.setNombre("Brandon"); o4.setApellido1("Startk"); o4.setApellido2("");
        Operario o5 = new Operario (); o5.setId_empl(5); o5.setNombre("Rickon"); o5.setApellido1("Stark"); o5.setApellido2("");
        Operario o6 = new Operario (); o6.setId_empl(6); o6.setNombre("Sansa"); o6.setApellido1("Startk"); o6.setApellido2("");
        ...
        Capataz cp1 = new Capataz(); cp1.setNombre("Eddard");
        Capataz cp2 = new Capataz(); cp2.setNombre("Stannis");
        Capataz cp3 = new Capataz(); cp3.setNombre("Joffrey");
